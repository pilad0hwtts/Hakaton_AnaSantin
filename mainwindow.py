...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(800, 444))
...
"padding: 0.1%;")
        ...
        self.StateMsg = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.StateMsg.setFont(font)
        self.StateMsg.setAlignment(QtCore.Qt.AlignCenter)
        self.StateMsg.setObjectName("StateMsg")
        self.verticalLayout_3.addWidget(self.StateMsg)
        ...
        self.horizontalLayout_6.addWidget(self.YesBtn)
        ...
        self.horizontalLayout_6.addWidget(self.NoBtn)
...
"padding: 0.1%;")
        ...
        self.stressLevelPB.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.stressLevelPB.setFont(font)
        self.stressLevelPB.setProperty("value", 0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.StateMsg.setText(_translate("MainWindow", "Добро пожаловать"))
        self.YesBtn.setText(_translate("MainWindow", "Да"))
        self.NoBtn.setText(_translate("MainWindow", "Нет"))
        ...
        self.stressLevelPB.setFormat(_translate("MainWindow", "Уровень стресса"))
